...
describe('randomizers', function () {
  describe('randomDigit', function () {
    it('should create random digits', function () {
      const array1 = Array.from({ length: 25 }, offhand.randomizer.randomDigit)
      const array2 = Array.from({ length: 25 }, offhand.randomizer.randomDigit)
  ...
  describe('randomLetter', function () {
    for (const [generator, characterSet] of [
      [offhand.randomizer.randomLowerCase, offhand.randomizer.LOWERCASE],
      [offhand.randomizer.randomUpperCase, offhand.randomizer.UPPERCASE],
      [
